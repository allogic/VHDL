...
-- Module  Version: 5.7
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n pll -lang vhdl -synth lse -arch xo2c00 -type pll -fin 38 -mdiv 1 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 6 -phase_cntl STATIC -rst -fb_mode 1 -lock -fracn 3449 

-- Thu May 04 00:11:06 2023
...
architecture Structure of pll is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "39.999847";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "38.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOP_TRIM_DELAY=>  0, CLKOP_TRIM_POL=> "RISING", FRACN_DIV=>  3449, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  6, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
